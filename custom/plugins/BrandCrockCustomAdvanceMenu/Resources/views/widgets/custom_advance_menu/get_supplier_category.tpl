        ...
        {block name="widgets_listing_get_category_name"}
            <div class="overlay--category">
                {block name="widgets_listing_get_category_name_link"}
                    <a href="{$supplier.link}" title="{$supplier.name|escape}">
                        <span class="category--headline">{$supplier.name}</span>
                    </a>
                {/block}
            </div>
        {/block}
                ...
                {block name="widgets_listing_get_category_categories_back"}
                    <li class="navigation--entry" role="menuitem">
                        {block name="widgets_listing_get_category_categories_back_link"}
                            <a href="{url module=widgets controller=listing action=getCategory categoryId={$parentCategoryId}}" data-parentId="{$parentCategoryId}" class="navigation--link is--back-button link--go-back" title="{s name="ButtonBack"}{/s}">
                ...
                {block name="widgets_listing_get_category_categories_show"}
                    <li class="navigation--entry" role="menuitem">
                        {block name="widgets_listing_get_category_categories_show_link"}
                            <a href="{$supplier.link}" title="{s name="ButtonShowPrepend"}{/s} {$supplier.name|escape} {s name="ButtonShowAppend"}{/s}"
                               class="navigation--link is--display-button">
                                {block name="widgets_listing_get_category_categories_show_link_name"}
                                    {s name="ButtonShowPrepend"}{/s} {$supplier.name} {s name="ButtonShowAppend"}{/s}
                                {/block}
                            </a>
                        {/block}
                    </li>
