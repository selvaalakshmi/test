...
Ext.define('Shopware.apps.Config.controller.Form', {
	...
	refs: [
		...
		{ ref: 'configStates', selector: 'config-form-friedmconfigstates' },
		{ ref: 'configDetail', selector: 'config-friedmconfigstates-detail' }
    ],
    */
    record: null,
    clickEdit: 0,
	init:function () {
        ...
        */
		...
		me.control({
            'config-form-friedmconfigstates': {
                editStates: me.editStates
            },
			'config-friedmconfigstates-detail': {
                'addStates': me.addStates,
                'edit': me.updateStates,
                'beforeedit': me.beforeEdit,
                'canceledit': me.cancelEdit,
            },
			'config-friedmconfigstates-detail dataview': {
                'drop': me.dropField
            },
        });
    ...
    addStates: function(){
    	var me = this,
            ...
            newField = Ext.create('Shopware.apps.Config.model.form.FriedmConfigStates', {
                position: count,
                id: null
            });
    ...
    dropField: function (node, data, overModel, dropPosition) {
		...
		Ext.Ajax.request({
            url: '{url controller=FriedmConfigStates action=sortList}',
            method: 'POST',
            params: {
