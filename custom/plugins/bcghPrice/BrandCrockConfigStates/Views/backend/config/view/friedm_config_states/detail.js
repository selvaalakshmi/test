...
Ext.define('Shopware.apps.Config.view.friedmConfigStates.Detail', {
    extend: 'Ext.grid.Panel',
    alias: 'widget.config-friedmconfigstates-detail',
    ...
    initComponent: function() {
        ...
        me.store = Ext.create('Shopware.apps.Config.store.detail.FriedmConfigStates');
