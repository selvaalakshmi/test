...
Ext.define('Shopware.apps.Config.view.form.FriedmConfigStates', {
    extend: 'Shopware.apps.Config.view.base.Form',
    alias: 'widget.config-form-friedmconfigstates',
    deletable: false,
    snippets: {
    ...
    getItems: function() {
		...
		me.statesDetail = Ext.create('Shopware.apps.Config.view.friedmConfigStates.Detail', {
			flex: 2
		});
