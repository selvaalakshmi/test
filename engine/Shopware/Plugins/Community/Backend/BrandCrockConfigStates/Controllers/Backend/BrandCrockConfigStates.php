...
class Shopware_Controllers_Backend_BrandCrockConfigStates extends Shopware_Controllers_Backend_ExtJs
{
...
//~ echo __line__; exit;
    ...
    /**
     * Shopware_Controllers_Backend_BrandCrockConfigStates::mkJsFile()
     *
     * @throws Exception
     */
    private function mkJsFile()
    {
        /** @var \Shopware_Plugins_Backend_BrandCrockConfigStates_Bootstrap $plugin */
        $plugin = $this->get('plugins')->Backend()->BrandCrockConfigStates();
        $plugin->mkJsFile();
    }
