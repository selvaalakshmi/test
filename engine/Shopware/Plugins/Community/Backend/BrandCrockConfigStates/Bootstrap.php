 ...
 * @subpackage     BrandCrockConfigStates
...
{
    private $pluginName = 'BrandCrockConfigStates';
    private $pluginDir = 'brand_crock_config_states';
    ...
    {
        return 'Brandcorck - Bestell- Zahlungsstatus';
    }
