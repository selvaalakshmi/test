...
class Article extends ModelEntity
{
    ...
    /**
     * @var string $bcghProductInfo
     *
     * @ORM\Column(name="bcgh_product_info", type="text", nullable=true)
     */
     protected $bcghProductInfo;
    ...
    public function getBcghProductInfo()
    {
        return $this->bcghProductInfo;
    }

    public function setBcghProductInfo($bcghProductInfo)
    {
        $this->bcghProductInfo = $bcghProductInfo;
        return $this;
    }
