    ...
    <div class="tab--navigation">
        {block name="frontend_detail_index_tabs_navigation_inner"}
            ...
            {block name="frontend_detail_index_tabs_entry_also_bought"}
                {if $showAlsoBought}
                    <a href="#content--also-bought" title="{s name="DetailRecommendationAlsoBoughtLabel" namespace="frontend/detail/index"}{/s}" class="tab--link tab_boght_nav">{s name="DetailRecommendationAlsoBoughtLabel" namespace="frontend/detail/index"}{/s}</a>
                {/if}
            {/block}
            ...
            {block name="frontend_detail_index_tabs_entry_also_viewed"}
                {if $showAlsoViewed}
                    <a href="#content--customer-viewed" title="{s name="DetailRecommendationAlsoViewedLabel" namespace="frontend/detail/index"}{/s}" class="tab--link tab_viewed_nav">{s name="DetailRecommendationAlsoViewedLabel" namespace="frontend/detail/index"}{/s}</a>
                {/if}
            {/block}
