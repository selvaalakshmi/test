        ...
        {block name="frontend_index_top_bar_main_container"}
            <div class="container block-group">
               ...
               <div class="topbar_options">
                   <div class="option_1"><span><img src='{link file='frontend/_public/src/img/icons/van.png' fullPath}' alt=""></span> SCHNELLER STANDARDVERSAND 1-2</div>
                   <div class="option_1"><span><img src='{link file='frontend/_public/src/img/icons/tag-icon.png' fullPath}' alt=""></span> 2 JAHRE GARANTIE</div>
                   <div class="option_1"><span><img src='{link file='frontend/_public/src/img/icons/mail-icon.png' fullPath}' alt=""></span> 24 STUNDEN KUNDENSUPPORT </div>
               </div>
